...
Route::post('/api/playlist/{playlist}/shuffle', 'Api\PlaylistController@postShuffle');
Route::get('/api/playlist/{playlist}/shuffle', 'Api\PlaylistController@postShuffle');
Route::post('/api/playlist/song/{song}/delete', 'Api\PlaylistController@postDeleteSong');
